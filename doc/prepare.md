...
- [Open generator-ui the first time](#open-generator-ui-the-first-time)
  ...
  - [Open generator-ui with Vscode](#open-generator-ui-with-vscode)
...
## Open generator-ui the first time
...
```bash
git clone https://github.com/rljson/generator-ui.git
```
