...
const filesToBeDeleted = [
  ...
  'doc/workflows/update-from-generator-ui.md',
];

const templateRepo = 'https://github.com/rljson/generator-ui.git';
const localRepoPath = path.resolve(__dirname, '../../generator-ui');
...
function replaceGeneratorUi() {
  ...
  for (const file of replaceFiles) {
    ...
    if (fs.existsSync(filePath)) {
      ...
      content = content.replace(/generator-ui/g, projectName);
